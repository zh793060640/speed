...
//                .setNumber(++pushNum) //设置通知集合的数量
    ...
    public void reset(){
        NotificationManager notificationManager = (NotificationManager)AppManager.I().getApplicationContext().getSystemService(AppManager.I().getApplicationContext().NOTIFICATION_SERVICE);
