...
public class EaseTitleBar extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        rightimdot = (ImageView) findViewById(R.id.right_image_dot);
    ...
    public void setDotVisibility(int status) {
        rightimdot.setVisibility(status);
    }
}
