...
public class CircleProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 位置
        mRectF.left = mCircleLineStrokeWidth / 2 + 20; // 左上角x
        mRectF.top = mCircleLineStrokeWidth / 2 + 20; // 左上角y
        mRectF.right = width - mCircleLineStrokeWidth / 2 - 20; // 左下角x
        mRectF.bottom = height - mCircleLineStrokeWidth / 2 - 20; // 右下角y
        ...
        canvas.drawArc(mRectF, 120, ((float) mProgress / mMaxProgress) * 360, false, mPaint);
